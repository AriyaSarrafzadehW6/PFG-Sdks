# PersiaFava SMS SDK — Ruby

کلاینت رسمی Ruby برای وب‌سرویس REST پیامک پرشیا فاوا. بدون وابستگی خارجی (فقط کتابخانه استاندارد Ruby).

## نصب

```bash
gem install persiafava-sms-sdk
```
...
- `PersiaFava::ApiException` — سرور پاسخ داد اما درخواست ناموفق بود
- `PersiaFava::HttpException` — ارتباط با سرور برقرار نشد
